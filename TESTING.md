...
| Automatic enrollment history repair is coalesced | A batch of large new shows causes one full Plex/Tautulli history read after triage, rather than one whole-history read per enrolled series |
