...
| Manual enrollment applies its pilot baseline before its full history reconciliation | Existing progress is applied to Sonarr immediately, while the slower full source read remains a corrective pass for missed activity |
