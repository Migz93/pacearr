...
| Scheduled reconciliation clears prefetches promoted to a retained season | Existing per-episode prefetch records are removed when active viewer progress makes their season fully retained, so the UI cannot display stale prefetch markers |
